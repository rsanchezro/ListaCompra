...
public class AdaptadorListaProductos extends RecyclerView.Adapter<AdaptadorListaProductos.Miholder> {
    private ArrayList<Llamada> lista_llamadas;
    private Context c;
    private int resource;
    public AdaptadorListaProductos(Context c, int r)
    {
    ...
    public AdaptadorListaProductos(ArrayList<Llamada> llamadas, Context c, int r) {
